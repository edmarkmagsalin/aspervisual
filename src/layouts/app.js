                ...
                <Container fluid>
                    <Row middle spaceBetween noWrap>
                        <Col sm='6' className={styles.logoContainer}>
                            <Link href='/'>
                                <a>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="71.603" height="114.365" viewBox="0 0 71.603 114.365" className={styles.logo}>
            ...
            <Section className={`${styles.footer} ${pathname !== '/' && styles.footerOtherPages}`}>
                <Container>
                    <Row middle spaceBetween>
                        <Col sm='12' md='3' lg='3' xl='3' style={{paddingBottom: 8}}>
                            FOR PROJECT INQUIRIES<br />
                            <a href="mailto:hello@aspervisual.com" target='_blank'>HELLO@ASPERVISUAL.COM</a>
                        </Col>
                        { pathname !== '/' &&
                            <Col sm='0' md='0' lg='6' xl='6' className={styles.dotContainer}>
